...
\begin{figure}[ht]
	\centering
  \includegraphics[width=\linewidth]{rosenbrock_0}
...
\begin{figure}[ht]
	\centering
  \includegraphics[width=\linewidth]{rosenbrock_1}
  \caption{ --- Функция Розенброка с параметрами $a = 1$, $b = 100$.}
...
\begin{figure}[h!]
\centering
\includegraphics[width=120mm]{PSO_0}
...
\begin{figure}[h!]
\centering
\includegraphics[width=120mm]{PSO_1}
\caption{ --- Оптимизационный процесс.}
\label{img:PSO_1}
\end{figure}
