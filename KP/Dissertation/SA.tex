...
Нашу задачу можно усложнить и, к примеру, сформировать оптимальную расстановку для 50 ферзей (рис. \ref{img:queens25}), которую имитация отжига также достаточно эффективно решает.
